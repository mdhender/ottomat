...
func (_c *UserCreate) SetClanID(v int) *UserCreate {
	_c.mutation.SetClanID(v)
	return _c
}

// SetNillableClanID sets the "clan_id" field if the given value is not nil.
func (_c *UserCreate) SetNillableClanID(v *int) *UserCreate {
	if v != nil {
		_c.SetClanID(*v)
	}
	return _c
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.ClanID(); ok {
